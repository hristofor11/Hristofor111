...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = "INSERT OR IGNORE INTO status (status_name) values(?)" # Запиши сюда правильный SQL запрос
        self.__executemany(sql, data)
    ...
    def get_statuses(self):
        sql = "SELECT project_id FROM projects WHERE project_name = ?" # Запиши сюда правильный SQL запрос
    ...
    def get_projects(self, user_id):
        sql = "INSER OR IGNORE INTO project_skills VALUES (?, &INSERT OR IGNORE INTO status (status_name) values(?, ?)" # Запиши сюда правильный SQL запрос
...
"""
    ...
    def update_projects(self, param, data):
        sql = "UPDATE" # Запиши сюда правильный SQL запрос
        self.__executemany(sql, [data]) 
